...
def delete_secret(path, *args, **kwargs):
    ...
    .. code-block:: vaultpolicy
        ...
        # KV v2 versions
        # all_versions=True additionally requires the policy for vault.read_meta
    ...
    if unknown_kwargs:
        raise SaltInvocationError(
            f"Passed unknown keyword arguments: {' '.join(unknown_kwargs)}"
        )
...
def destroy_secret(path, *args, **kwargs):
    ...
    .. code-block:: vaultpolicy
        ...
        # requires the policy for vault.read_meta
...
def wipe_secret(path):
    ...
    .. code-block:: bash
        ...
        salt '*' vault.forget_secret "secret/my/secret"
