...
def create_certificate(
    ...
    **kwargs,
    ...
    if kwargs.get("private_key"):
        pubkey = _check_ret(__salt__["ssh_pki.get_public_key"](kwargs["private_key"], passphrase=kwargs.get("private_key_passphrase")))
    elif kwargs.get("public_key"):
        pubkey = _check_ret(__salt__["ssh_pki.get_public_key"](kwargs["public_key"]))
...
def _get_file_or_data(data):
    ...
    try:
        ...
        if _check_ret(__salt__["file.file_exists"](data)):
            return _check_ret(__salt__["file.read"](data))
    return data
